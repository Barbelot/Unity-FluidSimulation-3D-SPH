...
namespace Seb.Fluid.Rendering
{
    public class MarchingCubesFluidRenderer : MonoBehaviour
    {
        ...
        void RenderFluid(RenderTexture densityTexture)
        {
            ...
            if (renderArgs == null)
            {
                renderArgs = new GraphicsBuffer(GraphicsBuffer.Target.IndirectArguments, 5, sizeof(uint));
            ...
            GraphicsBuffer.CopyCount(triangleBuffer, renderArgs, 0);
