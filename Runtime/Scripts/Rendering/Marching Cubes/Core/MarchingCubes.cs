...
namespace Seb.Fluid.Rendering
{
    ...
    public class MarchingCubes
    {
        ...
        readonly GraphicsBuffer lutBuffer;
        ...
        void ApplyComputeSettings(RenderTexture densityMap, Vector3 scale, float isoLevel, GraphicsBuffer triangleBuffer)
        {
        ...
        public GraphicsBuffer Run(RenderTexture densityTexture, Vector3 scale, float isoLevel)
        {
