...
namespace Seb.GPUSorting
{
    public class Scan
    {
        ...
        readonly Dictionary<int, GraphicsBuffer> freeBuffers = new();
        ...
        public void Run(GraphicsBuffer elements)
        {
            ...
            if (!freeBuffers.TryGetValue(numGroups, out GraphicsBuffer groupSumBuffer))
            {
