...
namespace Seb.GPUSorting
{
	public class GPUCountSort
	{
		...
		GraphicsBuffer sortedItemsBuffer;
		GraphicsBuffer sortedValuesBuffer;
		GraphicsBuffer countsBuffer;
		...
		public void Run(GraphicsBuffer itemsBuffer, GraphicsBuffer keysBuffer, uint maxValue)
		{
			// ---- Init ----
